...
function CommentsForm({ slug }) {
    ...
    const [localStorage, setLcalStorage] = useState(null)
        ...
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            ...
            <div className='mt-8'>
                <button
                    ...
                    className="px-8 py-3 cursor-pointer transition duration-500 ease-in hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white">
                    Post Comment
                </button>
                {showSuccessMessage && <span className='text-xl float-right font-semibold mt-3 text-green-500'>Comment submission</span>}
            </div>
        </div>
    )
}
